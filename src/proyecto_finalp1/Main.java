 ...
 */
    ...
    // Método recursivo para mejorar el Pokémon
    private static void mejorarPokemon(Scanner scanner, Entrenador entrenador) {
        ...
        // Llamada recursiva para repetir el proceso si el jugador quiere seguir mejorando
        System.out.println("¿Quieres seguir mejorando tu Pokémon? (1: Sí / 2: No)");
        int respuesta = validarEntrada(scanner, 1, 2);
        if (respuesta == 1) {
            mejorarPokemon(scanner, entrenador); // Llamada recursiva
        }
    }

    // Método sobrecargado para cambiar Pokémon
